...
func registerCoworking() {
	set(LangRU, "coworking_intro",
	...
	set(LangRU, "coworking_btn_booking", "🎁 Первый визит")
	set(LangEN, "coworking_btn_booking", "🎁 First visit")
	set(LangRU, "coworking_btn_meetingroom", "📅 Переговорная")
	set(LangEN, "coworking_btn_meetingroom", "📅 Meeting room")
	set(LangRU, "coworking_btn_events", "🎟 События")
	set(LangEN, "coworking_btn_events", "🎟 Events")
	set(LangRU, "coworking_btn_bar", "☕ Бар")
	set(LangEN, "coworking_btn_bar", "☕ Bar")
	set(LangRU, "coworking_btn_about", "ℹ️ О нас / карта")
	set(LangEN, "coworking_btn_about", "ℹ️ About & map")
	set(LangRU, "coworking_btn_language", "🌐 Язык")
	set(LangEN, "coworking_btn_language", "🌐 Language")
}
